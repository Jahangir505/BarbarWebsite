    ...
    <main class="app-content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="tile">
          <a href="{{route('gallery.create')}}" class="btn btn-primary ml-auto tile-title">Add Gallery</a>
              ...
              <table class="table table-bordered" id="sampleTable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$data->title}}</td>
                    <td>{{$data->subtitle}}</td>
                    <td><img class="img-thumbnail" src="{{asset('uploads/gallery/'.$data->image)}}" alt="" width="50"></td>
                    <td>
                      <a href="{{route('gallery.edit',$data->id)}}" class="btn btn-info btn-sm"><i class="fa fa-pencil fa-lg"></i></a>
